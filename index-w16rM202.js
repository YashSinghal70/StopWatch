  ...
  function E(C, N) {
    ...
    try {
      ...
      if (m !== null) var bt = !0;
        ...
        var hn = t(c);
        hn !== null && yl(h, hn.startTime - N), (bt = !1);
      }
      return bt;
    } finally {
      (m = null), (p = z), (g = !1);
...
function Uc(e, n, t, r, l, u, o, i, s) {
  (Ct = !1), (Rr = null), Fc.apply(jc, arguments);
}
...
function Sr(e) {
  ...
  for (var n = e.targetContainers; 0 < n.length; ) {
    ...
    } else return (n = Jt(t)), n !== null && Ju(n), (e.blockedOn = t), !1;
    n.shift();
  }
  return !0;
}
...
function qu(e, n, t, r) {
  if (Ir) {
    var l = cu(e, n, t, r);
    if (l === null) Dl(e, n, r, Fr, t), Yo(e, r);
...
var Fr = null;
function cu(e, n, t, r) {
  if (((Fr = null), (e = Xu(r)), (e = Sn(e)), e !== null))
  ...
  tl = A({}, Zt, {
    ...
    movementX: function (e) {
      return "movementX" in e
        ...
        : (e !== mt &&
            (mt && e.type === "mousemove"
              ? ((xl = e.screenX - mt.screenX), (Pl = e.screenY - mt.screenY))
              : (Pl = xl = 0),
            (mt = e)),
          xl);
    },
...
var Nf = We && "TextEvent" in window && !_t,
  Is = We && (!to || (_t && 8 < _t && 11 >= _t)),
  bo = " ",
  ei = !1;
function Fs(e, n) {
  switch (e) {
...
function ri() {
  xt && (xt.detachEvent("onpropertychange", As), (jt = xt = null));
}
function As(e) {
  if (e.propertyName === "value" && rl(jt)) {
    var n = [];
    Us(n, jt, e, Xu(e)), ws(Rf, n);
  }
}
function Mf(e, n, t) {
  e === "focusin"
    ? (ri(), (xt = n), (jt = t), xt.attachEvent("onpropertychange", As))
    : e === "focusout" && ri();
}
function Df(e) {
...
function I(e) {
  0 > $n || ((e.current = gu[$n]), (gu[$n] = null), $n--);
}
function M(e, n) {
  $n++, (gu[$n] = e.current), (e.current = n);
}
var dn = {},
  re = mn(dn),
  ce = mn(!1),
...
function yo(e, n, t, r, l, u) {
  if (
    ...
    u = 0;
    do {
      if (((Nt = !1), (Wt = 0), 25 <= u)) throw Error(y(301));
      (u += 1),
        (G = K = null),
        (n.updateQueue = null),
        (_r.current = ld),
  ...
  td = {
    ...
    useSyncExternalStore: function (e, n, t) {
      ...
      return (
        ...
        (r.flags |= 2048),
        Kt(9, ca.bind(null, r, u, t, n), void 0, null),
        t
      );
    },
    useId: function () {
...
function Cu(e, n, t, r) {
  ...
  typeof u == "object" && u !== null
    ? (l.context = _e(u))
    : ((u = fe(n) ? xn : re.current), (l.context = bn(e, u))),
...
function Li(e, n, t, r, l) {
  ...
  if ((Zn(n, l), n.stateNode === null))
    Pr(e, n), Pa(n, t, r), Cu(n, t, r, l), (r = !0);
  else if (e === null) {
    var o = n.stateNode,
      i = n.memoizedProps;
    o.props = i;
    ...
    (o.state = p),
      ...
      i !== r || p !== s || ce.current || Je
        ? (typeof v == "function" && (Eu(n, t, v, r), (s = n.memoizedState)),
    ...
    i !== m || p !== w || ce.current || Je
      ? (typeof g == "function" && (Eu(n, t, g, r), (w = n.memoizedState)),
...
function Ti(e, n, t, r, l) {
  return et(), oo(l), (n.flags |= 256), le(e, n, t, r), n.child;
}
...
function ad(e, n, t) {
  ...
  switch ((uo(n), n.tag)) {
    ...
    case 4:
      return (
        tt(), Lu(e, n), e === null && $t(n.stateNode.containerInfo), ne(n), null
      );
    case 10:
...
function Ua(e) {
  ...
  n !== null && ((e.alternate = null), Ua(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Fe], delete n[Vt], delete n[yu], delete n[Xf], delete n[Gf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Ha(e, n) {
  ...
  if (n !== 0) {
    if (
      (n === 2 && ((l = su(e)), l !== 0 && ((r = l), (n = Fu(e, l)))), n === 1)
    )
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
        ...
        case 3:
          if (
            ...
            e.timeoutHandle = hu(wn.bind(null, e, se, $e), n);
            break;
          }
          wn(e, se, $e);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = hu(wn.bind(null, e, se, $e), r);
            break;
          }
          wn(e, se, $e);
          break;
...
function qr(e, n) {
  ...
  while (!0);
  if ((so(), (R = t), (Gr.current = r), Q !== null)) throw Error(y(261));
  return (Z = null), (q = 0), Y;
}
function hd() {
  for (; Q !== null; ) Ka(Q);
...
Ga = function (e, n, t) {
  ...
  else (ae = !1), j && n.flags & 1048576 && bs(n, Br, n.index);
...
function Lr(e, n, t, r, l, u) {
  ...
  if (((r = e), typeof e == "function")) zo(e) && (o = 1);
    ...
    e: switch (e) {
      ...
      case Yl:
        return (
          (e = Ee(12, t, n, l | 2)), (e.elementType = Yl), (e.lanes = u), e
        );
      case Xl:
        return (e = Ee(13, t, n, l)), (e.elementType = Xl), (e.lanes = u), e;
      case Gl:
        return (e = Ee(19, t, n, l)), (e.elementType = Gl), (e.lanes = u), e;
      case os:
        return fl(t, l, u, n);
      default:
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (Zu(n, t | 1), de(n, W()), !(R & 6) && ((lt = W() + 500), vn()));
      }
      break;
    case 13:
      Ln(function () {
...
ys = xo;
gs = Ln;
var zd = { usingClientEntryPoint: !1, Events: [Jt, Un, ul, vs, hs, xo] },
  yt = {
...
const Rd = () => {
  const [e, n] = Qn.useState(null),
    [t, r] = Qn.useState(null),
    l = Qn.useRef(null);
  function u() {
    r(Date.now()),
      n(Date.now()),
  ...
  return we.jsxs("div", {
    className: "cnter",
    children: [
      we.jsx("h1", { children: "StopWatch" }),
      we.jsxs("h2", { children: ["Stopwatch: ", i.toFixed(3)] }),
      we.jsxs("div", {
        className: "btns",
        children: [
          we.jsx("button", { onClick: u, children: "Start" }),
          we.jsx("button", { onClick: o, children: "Stop" }),
          we.jsx("button", { onClick: s, children: "Reset" }),
        ],
      }),
    ],
  });
...
function Od() {
  return we.jsx(we.Fragment, { children: we.jsx(Rd, {}) });
}
Ql.createRoot(document.getElementById("root")).render(
  we.jsx(gc.StrictMode, { children: we.jsx(Od, {}) })
);
